...
#sum sqaure is deviation from each of observation from the mean 
#mean squre = sum square/df (degrees of freedom)
#F value = mean square plot ID/mean squre of residuals --> gives us P-value
