...
```{r leaf litter data, echo = FALSE, message = FALSE}
...
```{r lake nitrogen, include = FALSE, message = FALSE}
...
```{r lake phosphorus, include = FALSE, message = FALSE}
...
```{r lake nutrient summaries, echo = FALSE, message = FALSE}
...
```{r nitrogen plot, echo=FALSE, message=FALSE}
