...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(#this is a widget
 #fluidPage flexible to what use wants, can be adapted easily to needs of code     
      # Select nutrient to plot
      selectInput(#this is a dropdown widget within panel
        inputId = #this is an internal tag
          "dropdown_input", 
                  label = "Nutrient",
