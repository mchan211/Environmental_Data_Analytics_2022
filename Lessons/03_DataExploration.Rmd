...
> Answer: Using the library() function, the console pulls up any attached packages as well as any conflicts within the package 
...
> ANSWER: Can be found in the Raw file - make sure you make a copy of this file and only make changes in this copied file
...
> Answer: You don't want to remove during a time series analysis
