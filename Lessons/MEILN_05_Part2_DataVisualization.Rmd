...
O3plot2 <- ggplot(EPAair) +
  geom_point(aes(x = Date, y = Ozone)) +
  theme_bw() #background is white with light gridlines
print(O3plot2)
...
mytheme <- theme_classic(base_size = 14) +
  theme(axis.text = element_text(color = "black"),#changing the text color of axis labels
...
O3plot5 <- ggplot(EPAair) +
  geom_point(aes(x = Date, y = Ozone)) +
  mytheme #setting up a theme - can be input into any other plots you set up and it will follow the theme
print(O3plot5)  

theme_set(mytheme) #this will set the theme for the rest of your plots to follow the theme you set
...
O3plot7 <- ggplot(EPAair, aes(x = Date, y = Ozone)) +
  geom_hline(yintercept = 50, lty = 2) + #hline is good if you want to categorize
  geom_hline(yintercept = 100, lty = 2) +
  geom_point(alpha = 0.5, size = 1.5) + #alpha is the transparency of your point
  geom_text(x = as.Date("2020-01-01"), y = 45, label = "good", hjust = 1, fontface = "bold") #add text into your plot+   # hjust = 1 means left align
  ...
  scale_x_date(limits = as.Date(c("2018-01-01", "2019-12-31")), #plots specific section of your data
    date_breaks = "2 months", date_labels = "%b %y") + #sets breaks within date and specifies how the data will be represented
  ylab(expression("O"[3]* " AQI Value")) +
  theme(axis.text.x = element_text(angle = 45,  hjust = 1)) #changing the angle of your text
print(O3plot7)  
