...
#5
scatter.ntl.lter.pipe <- ggplot(ntl.lter.pipe, aes(depth, temperature_C)) +
  geom_point() +
...
> Answer: Based on the figure, it looks that the temperature of the lake decreases based on the depth. However, it does not decrease in a linear trend - the figure shows an exponentially decreasing relationship meaning the temperature of the water decreases more rapidly with depth than would by seen in a linear relationship. 
