...
sfc.Nebraska.2018 <- st_sfc(crs.Nebraska.2018$geometry, crs=4269)

class(sfc.Nebraska.2018)

#5. Plot the data
summary(sfc.Nebraska.2018)

mapview(sfc.Nebraska.2018)

ggplot() + 
  geom_sf(data=sfc.Nebraska.2018)+
